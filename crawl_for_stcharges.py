...
def main():
    ...
    csv_writer = csv.DictWriter(out_f, fieldnames=['homepage', 'standard_charge_file_indirect_url', 'standard_charge_file_url'], lineterminator='\n')
    ...
    for row in res["rows"]:
        ...
        print(homepage)
        proc = subprocess.Popen(['hakrawler','-subs', '-u', '-w'],stdout=subprocess.PIPE, stdin=subprocess.PIPE)
