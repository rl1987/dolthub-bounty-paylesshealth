...
def main():
    ...
    links = tree.xpath('//a[contains(@href, "StandardCharges") or contains(@href, "standardcharges")]')
    print(links)
    ...
    for link in links:
        ...
        name = name.replace("Machine-readable (JSON) file of standard hospital charges for ", "")
        name = name.replace("Download the machine-readable (JSON) file of standard hospital charges for ", "")
        name = name.replace("Download the machine-readable (JSON) files of standard hospital charges for ", "")
        name = name.strip()
